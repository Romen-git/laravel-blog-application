    ...
    <div class="w-4/5 mx-auto">
        ...
        <div class="m-auto pt-20">
            ...
            <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="checkbox" class="bg-transparent border-b-2 inline text-2xl outline-none"
                    name="is_published">
                ...
                <input type="text" name="meta_robots" placeholder="Meta Robots..."
                    class="bg-transparent block border-b-2 w-full h-20 text-2xl outline-none pb-8">
